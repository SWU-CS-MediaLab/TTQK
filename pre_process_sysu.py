...
data_path = '/mnt/sda1/xyt/datasets/SYSU-MM01/ori_data'
...
np.save('/mnt/sda1/xyt/datasets/SYSU-MM01/train_rgb_resized_img.npy', train_img)
np.save('/mnt/sda1/xyt/datasets/SYSU-MM01/train_rgb_resized_label.npy', train_label)

# ir imges
train_img, train_label = read_imgs(files_ir)
np.save('/mnt/sda1/xyt/datasets/SYSU-MM01/train_ir_resized_img.npy', train_img)
np.save('/mnt/sda1/xyt/datasets/SYSU-MM01/train_ir_resized_label.npy', train_label)
